...
function onLoad()
    print("onLoad")
    local jsonUrl = "https://yifeeeeei.github.io/SorceryImages/simplified_card_infos.json" -- Replace this with your actual JSON URL
...
function getCardFaceUrl(card_id)
    local url = resource_url .. "images/" .. getCardType(card_id) .. "/" .. getCardElement(card_id) .. "/" .. card_id ..
                    "_" .. card_table[card_id] .. ".jpg"
    return url
end
